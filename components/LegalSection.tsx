...
const TriPartyDiagram = () => (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="w-full bg-white p-6 rounded-sm border border-frontier-slate/10 shadow-lg relative overflow-hidden mb-8"
    >
        ...
        <svg viewBox="0 0 300 200" className="w-full h-48 md:h-64">
            ...
            <motion.path 
              ...
              d="M 120 60 L 60 140" stroke="#2C3E50" strokeWidth="1" strokeDasharray="4,2" 
            />
            ...
            <motion.path 
              ...
              d="M 70 140 L 130 60" stroke="#C5A059" strokeWidth="2" markerEnd="url(#arrow-gold)" 
            />
             <motion.circle 
               initial={{ scale: 0 }}
               whileInView={{ scale: 1 }}
               ...
               cx="100" cy="100" r="10" fill="white" stroke="#C5A059" 
             />
            ...
            <motion.path 
              ...
              d="M 180 60 L 240 140" stroke="#2C3E50" strokeWidth="1" 
            />
            ...
            <motion.path 
              ...
              d="M 240 140 L 150 100" stroke="#7B241C" strokeWidth="1" markerEnd="url(#arrow-slate)" opacity="0.5" 
            />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
            <motion.span 
              ...
              viewport={{ once: true }}
              className="text-frontier-slate/50 font-bold tracking-widest uppercase text-sm"
            >Due Diligence</motion.span>
            <motion.h2 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="font-serif text-3xl md:text-4xl font-bold text-frontier-slate mt-2 mb-6"
            >
        ...
        <div className="grid lg:grid-cols-12 gap-12 max-w-7xl mx-auto items-start">
            ...
            <div className="lg:col-span-8 grid gap-8">
                ...
                <motion.div 
                  ...
                  className="bg-frontier-limestone p-8 rounded-sm border-l-4 border-frontier-slate shadow-sm hover:shadow-md transition-shadow"
                >
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.2 }}
                  className="bg-frontier-limestone p-8 rounded-sm border-l-4 border-frontier-gold shadow-sm hover:shadow-md transition-shadow"
                >
                    <div className="flex items-center gap-3 mb-4">
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.4 }}
                  className="bg-frontier-limestone p-8 rounded-sm border-l-4 border-frontier-red shadow-sm hover:shadow-md transition-shadow"
                >
                    <div className="flex items-center gap-3 mb-4">
            ...
            <div className="lg:col-span-4 space-y-8 sticky top-32">
                 ...
                 <motion.div 
                   ...
                   viewport={{ once: true }}
                   transition={{ delay: 0.6 }}
                   className="bg-white p-6 rounded-sm border border-frontier-slate/10 shadow-lg"
                 >
